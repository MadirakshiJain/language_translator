...
import 'package:language_translator/result.dart';
...
Future<void> scanImage() async {
  ...
  try {
    ...
    final recognizedText = recognizerText.text;

    // Translate recognized text
    final translator = GoogleTranslator();
    final translatedText = await translator.translate(recognizedText, from: 'en', to: 'hi');
    
    // Navigate to ResultScreen with translated text
   await navigator.push(
  MaterialPageRoute(
    builder: (context) => ResultScreen(text: recognizedText),
  ),
);
